const {
  ...
  contract('Test', function([_, user, someone]) {
    let id;
    ...
    describe('Token to Ether', function() {
      ...
      describe('Exact input', function() {
        ...
        it('HBTC', async function() {
          const value = ether('10');
          const to = this.hQuickSwap.address;
          const path = [HBTC_TOKEN, WMATIC_TOKEN];
          const result = await this.router.getAmountsOut.call(value, path, {
            from: someone,
          });
          const data = abi.simpleEncode(
        ...
        it('USDT', async function() {
          ...
          const to = this.hQuickSwap.address;
          const path = [USDT_TOKEN, WMATIC_TOKEN];
          const result = await this.router.getAmountsOut.call(value, path, {
            from: someone,
          });
          const data = abi.simpleEncode(
    ...
    describe('Token to Token', function() {
      ...
      describe('Exact input', function() {
        ...
        it('HBTC', async function() {
          const value = ether('100');
          const to = this.hQuickSwap.address;
          const path = [HBTC_TOKEN, WMATIC_TOKEN, token1Address];
          const result = await this.router.getAmountsOut.call(value, path, {
            from: someone,
          });
          const data = abi.simpleEncode(
        ...
        it('USDT', async function() {
          const value = new BN('1000000');
          const to = this.hQuickSwap.address;
          const path = [USDT_TOKEN, WMATIC_TOKEN, token1Address];
          const result = await this.router.getAmountsOut.call(value, path, {
            from: someone,
          });
          const data = abi.simpleEncode(
